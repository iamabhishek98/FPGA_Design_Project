...
module VGA_DISPLAY(
    ...
    input [11:0] intensity_color,
    input [5:0] intensity_bar,
    ...
    //wire intensity = intensity_bar ;
    
    // COMBINE ALL OUTPUTS ON EACH CHANNEL
    wire[3:0] VGA_RED_CHAN = VGA_RED_GRID | VGA_RED_WAVEFORM | (intensity_bar ? intensity_color[3:0] : 0);
    wire[3:0] VGA_GREEN_CHAN = VGA_GREEN_GRID | VGA_GREEN_WAVEFORM | (intensity_bar ? intensity_color[7:4] : 0); 
    wire[3:0] VGA_BLUE_CHAN = VGA_BLUE_GRID | VGA_BLUE_WAVEFORM | (intensity_bar ? intensity_color[11:8] : 0);   
